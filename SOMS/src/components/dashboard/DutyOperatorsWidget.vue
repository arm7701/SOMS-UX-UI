...
<template>
  <div class="p-4 h-full flex flex-col justify-between space-y-3">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 flex-1 items-center">
      <!-- MD -->
      <div class="p-3.5 rounded-xl bg-[#1a4175] border border-sky-600/40 hover:border-cyan-400/60 transition-colors flex items-start gap-3 shadow-xs">
        ...
        <div class="min-w-0">
          <span class="text-xs font-bold text-sky-200 uppercase tracking-wider block font-prompt">
            Mission Director
          </span>
      ...
      <!-- FMO -->
      <div class="p-3.5 rounded-xl bg-[#1a4175] border border-sky-600/40 hover:border-emerald-500/40 transition-colors flex items-start gap-3 shadow-xs">
      ...
      <!-- GSO -->
      <div class="p-3.5 rounded-xl bg-[#1a4175] border border-sky-600/40 hover:border-amber-500/40 transition-colors flex items-start gap-3 shadow-xs">
