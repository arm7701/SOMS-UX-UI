...
<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center gap-1.5 overflow-x-auto pb-1 scrollbar-none text-xs font-semibold select-none font-prompt">
      <span class="text-zinc-400 flex items-center gap-1 mr-1 flex-shrink-0 font-semibold">
