        ...
        <thead class="bg-space-800 text-zinc-200 text-[11px] sm:text-xs font-semibold uppercase tracking-wider border-b border-space-700 select-none">
          <tr>
            <th
              ...
              :key="col.key"
              scope="col"
              class="py-3 px-3.5 sm:px-4 transition-colors font-prompt"
              :class="[
            ...
            <th v-if="$slots.actions" scope="col" class="py-3 px-4 text-center w-36 font-prompt">
              การจัดการ
            </th>
          </tr>
        </thead>
        <tbody class="divide-y divide-space-750">
          ...
          >
            <td
              v-for="col in columns"
              :key="col.key"
              class="py-3 px-3.5 sm:px-4 align-middle font-prompt text-slate-100"
